...
const values = [
  {
    ...
    desc: "We ship fast, iterate on real feedback, and keep moving. Waiting months to launch is just lost time — ship it good, then make it better.",
    color: "#2563eb",
...
const whyUs = [
  { stat: "100%",    label: "Full-stack — web, AI, and custom software",           color: "#2563eb" },
  { stat: "AI",      label: "Native — intelligence built in from the ground up",   color: "#0ea5e9" },
