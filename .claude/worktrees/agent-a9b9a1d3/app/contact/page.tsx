            ...
            <div style={{ background: "white", border: "1px solid var(--border)", borderRadius: "var(--radius-xl)", padding: "2.5rem", boxShadow: "var(--shadow-md)" }}>
              {status === "success" ? (
                <div style={{ textAlign: "center", padding: "3rem 1rem" }}>
                  ...
                  <p style={{ color: "var(--slate-600)", lineHeight: 1.7, marginBottom: "1.5rem" }}>
                    Thanks for reaching out. We'll be in touch within one business day. Check your inbox — you should have a confirmation email too.
                  </p>
